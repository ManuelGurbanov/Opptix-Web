    ...
    return (
        <div>
            <header className="flex items-center justify-between w-full px-24 py-6">
              ...
              <a href="/services/0" className="flex items-center w-56 px-4 py-2 text-white bg-black rounded-3xl hover:scale-105">
                <p>Explorar más</p>
                <div className="h-6 -rotate-45 w-9">
            ...
            <div className='container text-white'>
                <a class="box box1 text-left rounded-3xl relative" href='/services/0'>
                    <h1 className='absolute text-2xl bottom-8 left-4'>Configuradores 3D</h1>
                    <p className='absolute text-xs font-light bottom-4 left-4'>Phasellus faucibus scelerisque eleifend donec.</p>
                ...
                <a class="box box4 flex flex-col items-start justify-end text-left p-7 text-black relative" href='/services/3'>
                    <h1 className='text-2xl text-black'>Render Estático</h1>
