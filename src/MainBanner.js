...
function MainBanner({ language }) {
  return (
    <div className='relative md:w-[94%] sm:h-[75vh] w-screen h-screen flex flex-col justify-center items-start text-white p-3 px-12 rounded-3xl mb-12 overflow-hidden'>
      {/* Video Background */}
      <video
