            ...
            <div className={`flex flex-col items-start justify-center gap-12 m-0 mb-16 bg-white lg:flex-row sm:p-8 sm:mb-0 transition-opacity duration-0 ease-in-out ` } >
                ...
                {activePack === pack.id ? (
                    <>
                        ...
                        <p className='text-[16px] my-2 w-full text-left italic font-extralight' data-aos="fade-up">{pack.description}</p>

                        <ul className="list-disc pl-5 text-left font-extralight w-full mb-3 text-[17.43px]" data-aos="fade-up">
                        ...
                        <div data-aos="fade-up" className={"grid grid-flow-row-dense grid-cols-2 auto-cols-max gap-3 text-white justify-start text-[10px] text-nowrap mb-2"}>
