...
function RackModel({ showingMeshes, onMeshesLoaded }) {
  ...
  scene.traverse((child) => {
    if (child.isMesh) {
      ...
      const isVisible = showingMeshes && showingMeshes.length > 0 ? showingMeshes.some((key) => meshName.startsWith(key)) : false;
    ...
    ref={containerRef}>
      <Canvas
        ...
        style={{
          ...
          height: isFullscreen ? "100vw" : "70vh",
          minWidth: "450px",
          minHeight: "250px",
          position: "relative",
      ...
      >
        ...
        <RackModel showingMeshes={showingMeshes} onMeshesLoaded={(meshes) => console.log("Loaded Meshes:", meshes)} />
        <OrbitControls enableZoom={true} enableRotate={true} />
        <directionalLight position={[-3, 5, -4]} intensity={1.7} />
        <directionalLight position={[3, 5, 10]} intensity={0.8} />
        <directionalLight position={[0, -10, 0]} intensity={0.3} />
      </Canvas>
                <header className="absolute sm:flex hidden items-start justify-end top-4 right-7 w-full gap-2">
                <div className="hidden sm:block">
                  <SeeButton language={language} qrCode="/qrcodes/rack.png" />
                </div>
                <button
      ...
      <div className="grid grid-cols-2 gap-3 absolute top-0 left-0 p-4">
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["01"]) }>
          <img src="/buttons/01.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["02", "01"]) }>
        <img src="/buttons/01-02.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["03", "02", "01"]) }>
        <img src="/buttons/01-02-03.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["04"]) }>
        <img src="/buttons/04.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["04", "05"]) }>
        <img src="/buttons/04-05.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["04", "05", "03"]) }>
        <img src="/buttons/03-04-05.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["04", "02", "03"]) }>
        <img src="/buttons/02-03-04.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["02", "04"]) }>
        <img src="/buttons/02-04.png" className="w-16 h-16"></img>
        </button>
        <button className="w-20 h-20 hover:bg-lightblue transition-all duration-75 bg-lightblue6 rounded-full flex items-center justify-center" onClick={() => setVisibleMeshes(["06","05", "04"]) }>
